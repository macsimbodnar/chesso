...
CASES = [
    ...
    dict(
        ...
        anchors={"evaluate": 530, "cheap": 524},
        stm="w",
        phase=2,
        material=[("ROOK", 1)],
...
QUIESCE_IN_CHECK = -491  # what test_search pins on the shipped weights
