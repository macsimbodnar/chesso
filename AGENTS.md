...
- AGENTS: **every plan step is implemented by one clean Opus 5 subagent,
  ...
  2026-09-11; Sonnet 5 between DEC-188 and DEC-199, both 2026-09-12). The brief
...
- COPYING: **nothing is copied, ever.** No source from another engine, no
  ...
  DEC-016.
  **From the description (DEC-221):** a technique taken from the 2026-09-19
  analysis of literature and open-source resources is implemented from its
  description in the analysis or a publication, seeded in DEC-134's forms,
  and the completion stamp says so.
