...
Status: closed as to the mechanism — S212, DEC-204 (a), 2026-09-13: the stamp is generated at build time through `cmake/build_info.cmake` on every build, not at configure time; the suggested freshness test (configure once, flip the commit or dirty state, rebuild without reconfiguring, `id name` follows) is **planned — S228** (DEC-206). Previously: open.
