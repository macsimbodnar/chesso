...
- **The 2026-09-19 study of a reference engine's test ledger was adversarially
  reviewed and the owner ruled on nine items the same day; nothing is measured
  ...
  the clone, a cold Opus 5 reviewer on the reasoning); the study corrected in
  place and renamed `adocs/data/2026-09-19_search_technique_study.md`, its
  parser committed as `2026-09-19_technique_ledger.py`. **Anonymised
  (DEC-221):** no engine name, repository path, commit hash or pull-request
  number of that repository anywhere in the tree; the key is in
  `.moltke.local.md`. **What the
  ...
  DEC-176 (c)); the engine later replaced internal iterative reduction; S099
  ...
  DEC-221 (copyleft engine read for technique only, clean room, anonymity),
