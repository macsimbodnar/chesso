...
The survey is done. The owner's download; four fixed-rounds comparison
matches of 1000 games at about 2000 to 2300 an hour -- roughly two hours,
longer where a balanced book plays longer games; the A/A on the pick, another
half hour; an hour to read and record. Under DEC-155's four-hour line, so a
daytime run, and the pins land in the same commit as the switch.
