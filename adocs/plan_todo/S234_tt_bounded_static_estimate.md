...
measured at +6.07 over 8414 games in the engine it read, with the raw static
...
this verdict is DEC-143's, not that engine's.
...
The implementing agent's brief carries this file and the study's row N1 in
